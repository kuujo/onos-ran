...
import (
	hoappsouthbound "github.com/onosproject/onos-ran/pkg/apps/onos-ran-ho/southbound"
	log "k8s.io/klog"
)

var appMgr AppManager

// AppManager is a single point of entry for Handover application running over ONOS-RAN subsystem.
