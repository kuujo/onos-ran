...
type MessageId struct {
	Type   sb.MessageType `protobuf:"varint,1,opt,name=type,proto3,enum=interface.e2.MessageType" json:"type,omitempty"`
	PlmnId string         `protobuf:"bytes,2,opt,name=plmn_id,json=plmnId,proto3" json:"plmn_id,omitempty"`
	Ecid   string         `protobuf:"bytes,3,opt,name=ecid,proto3" json:"ecid,omitempty"`
	Crnti  string         `protobuf:"bytes,4,opt,name=crnti,proto3" json:"crnti,omitempty"`
}
...
func (m *MessageId) GetType() sb.MessageType {
	if m != nil {
		return m.Type
	}
...
func (m *MessageId) GetPlmnId() string {
	if m != nil {
		return m.PlmnId
	}
	return ""
...
func (m *MessageId) GetEcid() string {
	if m != nil {
		return m.Ecid
	}
	return ""
...
func (m *MessageId) GetCrnti() string {
	if m != nil {
		return m.Crnti
	}
	return ""
...
func (*MessageEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_9f303d1c9557996c, []int{1}
}
...
func init() {
	proto.RegisterType((*MessageId)(nil), "onos.ric.store.message.MessageId")
...
var fileDescriptor_9f303d1c9557996c = []byte{
	...
	,
}
...
func (m *MessageId) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Crnti) > 0 {
		i -= len(m.Crnti)
		copy(dAtA[i:], m.Crnti)
		i = encodeVarintMessage(dAtA, i, uint64(len(m.Crnti)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Ecid) > 0 {
		i -= len(m.Ecid)
		copy(dAtA[i:], m.Ecid)
		i = encodeVarintMessage(dAtA, i, uint64(len(m.Ecid)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.PlmnId) > 0 {
		...
		i = encodeVarintMessage(dAtA, i, uint64(len(m.PlmnId)))
		i--
		dAtA[i] = 0x12
	}
	if m.Type != 0 {
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= sb.MessageType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
